...
SCHEMA_EDIT_TEXT = {
    ...
    "parameters": {
        "type": "object",
        "properties": {
            "file_path": {"type": "string", "description": "Relative or absolute path to the file to edit"},
            "old_string": {
                "type": "string",
...
SCHEMA_GREP = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "max_results": {"type": "integer", "description": "Max results to return (default: 200, max: 500)"},
            "context": {
                "type": "integer",
...
SCHEMA_GLOB = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "path": {"type": "string", "description": "Directory to restrict the search to (default: repo root)"},
...
SCHEMA_READ_SYMBOL = {
    ...
    "parameters": {
        "type": "object",
        "properties": {
            "name": {"type": "string", "description": "Symbol name to look for (function, class, or variable)"},
...
DESIGN_CHAT_ONLY_TOOL_NAMES: frozenset = frozenset(s["name"] for s in AGENT_TOOL_SCHEMAS if s.get("x_design_chat_only"))
...
def _schema_variant(*, python_only: bool, design_chat: bool) -> list[dict[str, Any]]:
    return [
        ...
        if (python_only or not s.get("x_python_only")) and (design_chat or not s.get("x_design_chat_only"))
    ]
...
TOOL_NAME_VARIANTS: dict[tuple[bool, bool], frozenset] = {
    key: frozenset(s["name"] for s in schemas) for key, schemas in TOOL_SCHEMA_VARIANTS.items()
}
